   ...
   '-------'
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobileScreen ? "1fr" : "1fr 390px", gap: "1.5rem", width: "100%", alignItems: "start" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            <div className="terminal-panel" style={{ display: "flex", flexDirection: "column", flex: "1 1 auto", marginTop: "0.68rem", height: isMobileScreen ? "auto" : "calc(100% - 460px - 0.75rem - 0.68rem)" }}>
              <div className="panel-header">
