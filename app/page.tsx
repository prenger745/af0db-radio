...
10M:  28.000 - 29.700 MHz`}
  ...
  (         )
   '-------'
          ...
          <div className="terminal-panel" style={{ marginTop: isMobileScreen ? "0px" : "11px", height: isMobileScreen ? "auto" : "680px", display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ flex: 1, overflowY: "auto", paddingRight: "0.25rem" }}>
              ...
              <div style={{ fontSize: "0.75rem", lineHeight: "1.35" }}>
                ...
                <div className="data-row" style={{ padding: "0.35rem 0", borderBottom: "none" }}>
