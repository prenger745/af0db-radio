    ...
    <div style={{ backgroundColor: "#030403", color: "#a3c2ae", minHeight: "100vh", padding: isMobileScreen ? "0.75rem" : "1.5rem", fontFamily: "monospace", boxSizing: "border-box", letterSpacing: "0.05em", position: "relative" }}>
      ...
      <main className={`deck-workspace ${showWorkspace ? "active" : ""}`}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          <div className="terminal-panel">
            <div className="panel-header" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "0.5rem" }}>
              <div className="panel-title" style={{ color: "#00ff66", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", flex: "1 1 auto" }}>
                <Compass style={{ width: "16px", height: "16px", minWidth: "16px" }} /> AF0DB LIVE QTH ENVIRONMENT
              </div>
              <span style={{ fontSize: "9px", color: "rgba(0, 255, 102, 0.4)", whiteSpace: "nowrap", textAlign: "right", flex: "0 0 auto", width: "125px" }}>[ ENVIRONMENT_ARRAY ]</span>
            </div>
