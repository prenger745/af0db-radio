    ...
    <div style={{
      ...
      <style dangerouslySetInnerHTML={{__html: `
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .log-table { width: full; width: 100%; border-collapse: collapse; margin-top: 1rem; font-size: 0.875rem; text-align: left; }
        .log-table th { background: rgba(255, 255, 255, 0.05); border-bottom: 1px solid rgba(255, 255, 255, 0.1); padding: 0.75rem 1rem; color: #9ca3af; font-size: 0.75rem; text-transform: uppercase; tracking-ratio: 0.05em; }
        ...
        .badge-mode { background: rgba(245, 158, 11, 0.1); border: 1px solid rgba(245, 158, 11, 0.2); color: #fbbf24; font-size: 11px; font-weight: bold; padding: 0.125rem 0.5rem; rounded: 4px; border-radius: 4px; font-family: monospace; }
      ...
      <main className="grid-container">
        ...
        <div className="card-deck" style={{ height: "fit-content" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", borderBottom: "1px solid rgba(255,255,255,0.1)", paddingBottom: "1rem", marginBottom: "1.25rem" }}>
            ...
            <h2 style={{ fontSize: "1.125rem", fontWeight: 700, textTransform: "uppercase", tracking: "0.05em" }}>Station Specs</h2>
          </div>
        ...
        {/* Right Card: Dynamic Sorted QSO Table Logbook */}
        <div className="card-deck" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "between", borderBottom: "1px solid rgba(255,255,255,0.1)", paddingBottom: "1rem", marginBottom: "1.25rem" }}>
            ...
            <div style={{ overflowX: "auto", borderRadius: "8px", background: "rgba(0,0,0,0.2)", border: "1px solid rgba(255,255,255,0.05)" }}>
              <table className="log-table">
                ...
                <tbody>
                  {qsoLogs.length === 0 ? (
                    <tr>
                      <td colSpan={7} style={{ padding: "3rem", textAlign: "center", color: "#6b7280", fontStyle: "italic", fontFamily: "monospace" }}>
                        Connecting to secure QRZ API logging stream...
                      </td>
                    </tr>
                  ) : (
          ...
          <footer style={{ marginTop: "2rem", paddingTop: "1rem", borderTop: "1px solid rgba(255,255,255,0.05)", display: "flex", justifyContent: "between", fontSize: "11px", color: "#6b7280", fontFamily: "monospace" }}>
